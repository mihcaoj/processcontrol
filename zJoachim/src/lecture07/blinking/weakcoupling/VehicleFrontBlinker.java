...
public class VehicleFrontBlinker implements MessageListener, Runnable {
    ...
    public VehicleFrontBlinker(MqttHandler mqttHandler) throws MqttException {
        ...
        this.mqttHandler.subscribe("Blinking/U/JRB/WeakCoupling/ConnectedObserver/E/vehicleConnected");
    }
        ...
        try {
            ...
            String vehicleId = null;
            {
                ...
                while (!conditionAchieved) {
                    ...
                    if (mqttMessageRecord.topic.endsWith("U/JRB/WeakCoupling/ConnectedObserver/E/vehicleConnected")) {
                ...
                while (true) {
                    ...
                    mqttHandler.publish("Anki/Vehicles/U/" + vehicleId + "/I/JRB", payload.toString());
                    Thread.sleep(500);
